<?php
	...
	for($courtno = 0; $courtno < 1; $courtno++)
	{
		...
		$casecountquery2 = http_build_query($casecountquery);
		...
		curl_setopt($ch, CURLOPT_URL, $spiderurl."?".$casecountquery2 );
		//echo $spiderurl."?".$casecountquery2;
		//curl_setopt($ch, CURLOPT_POST, true);
		//curl_setopt($ch, CURLOPT_POSTFIELDS, $casecountquery2);
